...
public class ScheduleTest {
    ...
    private static void testFixedRate() {
        ...
        ScheduledFuture<?> alarmFuture = alarmExecutor.scheduleAtFixedRate(new MyRunnable("fixedRate"), 0,
                SCHEDULE_MINUTES, TimeUnit.MINUTES);
    }
    ...
    private static void testFixedDelay() {
        ...
        ScheduledFuture<?> alarmUserFuture = alarmUserFlushExecutor.scheduleWithFixedDelay(new MyRunnable("fixedDelay"),
                0, SCHEDULE_MINUTES, TimeUnit.MINUTES);
    }
