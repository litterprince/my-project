!function (e, t) {
    ...
    function c(e, t, n, r) {
        if (je(e)) {
            ...
            if (l && u[l] && (r || u[l].data) || void 0 !== n || "string" != typeof t) return l || (l = s ? e[a] = ne.pop() || pe.guid++ : a), u[l] || (u[l] = s ? {} : {toJSON: pe.noop}), "object" != typeof t && "function" != typeof t || (r ? u[l] = pe.extend(u[l], t) : u[l].data = pe.extend(u[l].data, t)), o = u[l], r || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[pe.camelCase(t)] = n), "string" == typeof t ? null == (i = o[t]) && (i = o[pe.camelCase(t)]) : i = o, i
        }
    }
    ...
    function v(e, t, n, r, i) {
        for (var o, a, s, u, l, c, d, f = e.length, v = p(t), y = [], x = 0; f > x; x++) if ((a = e[x]) || 0 === a) if ("object" === pe.type(a)) pe.merge(y, a.nodeType ? [a] : a); else if (Xe.test(a)) {
            for (u = u || v.appendChild(t.createElement("div")), l = (We.exec(a) || ["", ""])[1].toLowerCase(), d = ze[l] || ze._default, u.innerHTML = d[1] + pe.htmlPrefilter(a) + d[2], o = d[0]; o--;) u = u.lastChild;
            if (!de.leadingWhitespace && Pe.test(a) && y.push(t.createTextNode(Pe.exec(a)[0])), !de.tbody) for (a = "table" !== l || Ue.test(a) ? "<table>" !== d[1] || Ue.test(a) ? 0 : u : u.firstChild, o = a && a.childNodes.length; o--;) pe.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
            for (pe.merge(y, u.childNodes), u.textContent = ""; u.firstChild;) u.removeChild(u.firstChild);
            u = v.lastChild
        } else y.push(t.createTextNode(a));
        for (u && v.removeChild(u), de.appendChecked || pe.grep(h(y, "input"), g), x = 0; a = y[x++];) if (r && pe.inArray(a, r) > -1) i && i.push(a); else if (s = pe.contains(a.ownerDocument, a), u = h(v.appendChild(a), "script"), s && m(u), n) for (o = 0; a = u[o++];) Be.test(a.type || "") && n.push(a);
        return u = null, v
    }
    ...
    function S(e, t, n, r) {
        ...
        if (d && (l = v(t, e[0].ownerDocument, !1, e, r), i = l.firstChild, 1 === l.childNodes.length && (l = i), i || r)) {
            ...
            if (a) for (u = s[s.length - 1].ownerDocument, pe.map(s, E), c = 0; a > c; c++) o = s[c], Be.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(u, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(it, "")));
            l = i = null
        }
        return e
    }
    ...
    function B(e, t, n) {
        var r, i, o, a, s, u, l, c = this, d = {}, f = e.style, p = e.nodeType && Oe(e), h = pe._data(e, "fxshow");
        ...
        if (pe.isEmptyObject(d)) "inline" === ("none" === l ? L(e.nodeName) : l) && (f.display = l); else {
            ...
            for (r in d) a = W(p ? h[r] : 0, r, c), r in h || (h[r] = a.start, p && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function I(e, t, n) {
        var r, i, o = 0, a = I.prefilters.length, s = pe.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (i) return !1;
        ...
        for (P(c, l.opts.specialEasing); a > o; o++) if (r = I.prefilters[o].call(l, e, c, l.opts)) return pe.isFunction(r.stop) && (pe._queueHooks(l.elem, l.opts.queue).stop = pe.proxy(r.stop, r)), r;
    ...
    var ne = [], re = e.document, ie = ne.slice, oe = ne.concat, ae = ne.push, se = ne.indexOf, ue = {},
        le = ue.toString, ce = ue.hasOwnProperty, de = {}, fe = "1.12.4", pe = function (e, t) {
    ...
    var ye = function (e) {
        function t(e, t, n, r) {
            var i, o, a, s, l, d, f, p, h = t && t.ownerDocument, m = t ? t.nodeType : 9;
        ...
        function d(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (a) {
                    ...
                    if (l = t[O] || (t[O] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (s = u[r]) && s[0] === $ && s[1] === o) return c[2] = s[2];
        ...
        function m(e, t, n, i, o, a) {
            return i && !i[O] && (i = m(i)), o && !o[O] && (o = m(o, a)), r(function (r, a, s, u) {
                var l, c, d, f = [], m = [], g = a.length, v = r || p(t || "*", s.nodeType ? [s] : s, []),
                    y = !e || !r && t ? v : h(v, f, e, s, u), x = n ? o || (r ? e : g || i) ? [] : a : y;
                if (n && n(y, x, s, u), i) for (l = h(x, m), i(l, [], s, u), c = l.length; c--;) (d = l[c]) && (x[m[c]] = !(y[m[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function g(e) {
            for (var t, n, r, i = e.length, o = b.relative[e[0].type], a = o || b.relative[" "], s = o ? 1 : 0, u = d(function (e) {
                ...
                if (n = b.filter[e[s].type].apply(null, e[s].matches), n[O]) {
                    ...
                    return m(s > 1 && f(p), s > 1 && c(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(oe, "$1"), n, r > s && g(e.slice(s, r)), i > r && g(e = e.slice(r)), i > r && c(e))
                }
                p.push(n)
            }
            return f(p)
        ...
        function v(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                var c, d, f, p = 0, m = "0", g = r && [], v = [], y = k, x = r || o && b.find.TAG("*", l),
                    w = $ += null == y ? 1 : Math.random() || .1, T = x.length;
                for (l && (k = a === L || a || l); m !== T && null != (c = x[m]); m++) {
                    if (o && c) {
                        for (d = 0, a || c.ownerDocument === L || (D(c), s = !H); f = e[d++];) if (f(c, a || L, s)) {
                            u.push(c);
                            break
                        }
                        l && ($ = w)
                ...
                if (p += m, i && m !== p) {
                    ...
                    if (r) {
                        if (p > 0) for (; m--;) g[m] || v[m] || (v[m] = Y.call(u));
                        v = h(v)
                    }
        ...
        var y, x, b, w, T, C, E, N, k, S, A, D, L, j, H, q, _, M, F, O = "sizzle" + 1 * new Date, R = e.document, $ = 0,
            W = 0, B = n(), P = n(), I = n(), z = function (e, t) {
                return e === t && (A = !0), 0
        ...
        x = t.support = {}, T = t.isXML = function (e) {
            ...
            }, _ = [], q = [], (x.qsa = he.test(L.querySelectorAll)) && (i(function (e) {
            ...
            })), (x.matchesSelector = he.test(M = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && i(function (e) {
                x.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), _.push("!=", re)
            }), q = q.length && new RegExp(q.join("|")), _ = _.length && new RegExp(_.join("|")), t = he.test(j.compareDocumentPosition), F = t || he.test(j.contains) ? function (e, t) {
            ...
            if ((e.ownerDocument || e) !== L && D(e), n = n.replace(ue, "='$1']"), x.matchesSelector && H && !I[n + " "] && (!_ || !_.test(n)) && (!q || !q.test(n))) try {
                var r = M.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (f = g, d = f[O] || (f[O] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), l = c[e] || [], p = l[0] === $ && l[1], x = p && l[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (x = p = 0) || h.pop();) if (1 === f.nodeType && ++x && f === t) {
                                    c[e] = [$, p, x];
                                    break
                                }
                            } else if (y && (f = t, d = f[O] || (f[O] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), l = c[e] || [], p = l[0] === $ && l[1], x = p),
                                !1 === x) for (; (f = ++p && f && f[m] || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && (d = f[O] || (f[O] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [$, x]), f !== t));) ;
        ...
        return l.prototype = b.filters = b.pseudos, b.setFilters = new l, C = t.tokenize = function (e, n) {
            ...
            return n ? s.length : s ? t.error(e) : P(e, u).slice(0)
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = de.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !b.relative[s = a.type]);) if ((l = b.find[s]) && (r = l(a.matches[0].replace(ye, xe), ge.test(o[0].type) && u(t.parentNode) || t))) {
    ...
    pe.fn.ready = function (e) {
        ...
        if (!De) if (De = pe.Deferred(), "complete" === re.readyState || "loading" !== re.readyState && !re.documentElement.doScroll) e.setTimeout(pe.ready); else if (re.addEventListener) re.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s); else {
    ...
    var _e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Me = new RegExp("^(?:([+-])=|)(" + _e + ")([a-z%]*)$", "i"),
        Fe = ["Top", "Right", "Bottom", "Left"], Oe = function (e, t) {
        ...
        }, $e = /^(?:checkbox|radio)$/i, We = /<([\w:-]+)/, Be = /^$|\/(?:java|ecma)script/i, Pe = /^\s+/,
    ...
    var Ve = /^(?:input|select|textarea)$/i, Ye = /^key/, Je = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Ge = /^(?:focusinfocus|focusoutblur)$/, Qe = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {},
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(Ae) || [""], l = t.length; l--;) if (s = Qe.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, r, i) {
            var o, a, s, u, l, c, d, f = [r || re], p = ce.call(t, "type") ? t.type : t,
            ...
            if (s = c = r = r || re, 3 !== r.nodeType && 8 !== r.nodeType && !Ge.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : pe.makeArray(n, [t]), l = pe.event.special[p] || {}, i || !l.trigger || !1 !== l.trigger.apply(r, n))) {
                ...
                for (d = 0; (s = f[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? u : l.bindType || p, o = (pe._data(s, "events") || {})[t.type] && pe._data(s, "handle"), o && o.apply(s, n), (o = a && s[a]) && o.apply && je(s) && (t.result = o.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    var Ke = / jQuery\d+="(?:null|\d+)"/g, Ze = new RegExp("<(?:" + Ie + ")[\\s/>]", "i"),
        et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, tt = /<script|<style|<link/i,
        nt = /checked\s*(?:[^=]|=\s*.checked.)/i, rt = /^true\/(.*)/, it = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        ot = p(re), at = ot.appendChild(re.createElement("div"));
    pe.extend({
        htmlPrefilter: function (e) {
            return e.replace(et, "<$1></$2>")
        }, clone: function (e, t, n) {
            var r, i, o, a, s, u = pe.contains(e.ownerDocument, e);
            if (de.html5Clone || pe.isXMLDoc(e) || !Ze.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (at.innerHTML = e.outerHTML, at.removeChild(o = at.firstChild)), !(de.noCloneEvent && de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (r = h(o), s = h(e), a = 0; null != (i = s[a]); ++a) r[a] && k(i, r[a]);
            ...
            for (var n, r, i, o, a = 0, s = pe.expando, u = pe.cache, l = de.attributes, c = pe.event.special; null != (n = e[a]); a++) if ((t || je(n)) && (i = n[s], o = i && u[i])) {
        ...
        domManip: S, detach: function (e) {
            ...
            return Re(this, function (e) {
                ...
                if ("string" == typeof e && !tt.test(e) && (de.htmlSerialize || !Ze.test(e)) && (de.leadingWhitespace || !Pe.test(e)) && !ze[(We.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    var st, ut = {HTML: "block", BODY: "block"}, lt = /^margin/, ct = new RegExp("^(" + _e + ")(?!px)[a-z%]+$", "i"),
        dt = function (e, t, n, r) {
            var i, o, a = {};
    ...
    var gt = /alpha\([^)]*\)/i, vt = /opacity\s*=\s*([^)]*)/i, yt = /^(none|table(?!-c[ea]).+)/,
        xt = new RegExp("^(" + _e + ")(.*)$", "i"), bt = {position: "absolute", visibility: "hidden", display: "block"},
        wt = {letterSpacing: "0", fontWeight: "400"}, Tt = ["Webkit", "O", "Moz", "ms"],
    ...
    pe.extend({
        ...
        return t ? (parseFloat(ht(e, "marginLeft")) || (pe.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - dt(e, {marginLeft: 0}, function () {
        ...
        }, lt.test(e) || (pe.cssHooks[e + t].set = _)
    }), pe.fn.extend({
        css: function (e, t) {
    ...
    pe.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, u = 0 > i ? s : o ? i : 0; s > u; u++) if (n = r[u], (n.selected || u === i) && (de.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pe.nodeName(n.parentNode, "optgroup"))) {
    ...
    var Lt, jt, Ht = pe.expr.attrHandle, qt = /^(?:checked|selected)$/i, _t = de.getSetAttribute, Mt = de.input;
    pe.fn.extend({
        attr: function (e, t) {
        ...
        set: function (e, t, n) {
            return !1 === t ? pe.removeAttr(e, n) : Mt && _t || !qt.test(n) ? e.setAttribute(!_t && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0, n
        }
    ...
    pe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(Ae) || []; n = this[u++];) if (i = z(n), r = 1 === n.nodeType && (" " + i + " ").replace(Rt, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n) for (r = 0, i = pe(this), o = e.match(Ae) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || (t = z(this), t && pe._data(this, "__className__", t), pe.attr(this, "class", t || !1 === e ? "" : pe._data(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    var $t = e.location, Wt = pe.now(), Bt = /\?/,
        Pt = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
    pe.parseJSON = function (t) {
        if (e.JSON && e.JSON.parse) return e.JSON.parse(t + "");
        var n, r = null, i = pe.trim(t + "");
        return i && !pe.trim(i.replace(Pt, function (e, t, i, o) {
    ...
    var It = /#.*$/, zt = /([?&])_=[^&]*/, Xt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Ut = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Vt = /^(?:GET|HEAD)$/, Yt = /^\/\//,
        Jt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Gt = {}, Qt = {}, Kt = "*/".concat("*"),
        Zt = $t.href, en = Jt.exec(Zt.toLowerCase()) || [];
    pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (t, n) {
            ...
            var i, o, a, s, u, l, c, d, f = pe.ajaxSetup({}, n), p = f.context || f,
                h = f.context && (p.nodeType || p.jquery) ? pe(p) : pe.event, m = pe.Deferred(),
                g = pe.Callbacks("once memory"), v = f.statusCode || {}, y = {}, x = {}, b = 0, w = "canceled", T = {
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, f.url = ((t || f.url || Zt) + "").replace(It, "").replace(Yt, en[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = pe.trim(f.dataType || "*").toLowerCase().match(Ae) || [""], null == f.crossDomain && (i = Jt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === en[1] && i[2] === en[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = pe.param(f.data, f.traditional)), U(Gt, f, n, T), 2 === b) return T;
            l = pe.event && f.global, l && 0 == pe.active++ && pe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Vt.test(f.type), a = f.url, f.hasContent || (f.data && (a = f.url += (Bt.test(a) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (f.url = zt.test(a) ? a.replace(zt, "$1_=" + Wt++) : a + (Bt.test(a) ? "&" : "?") + "_=" + Wt++)), f.ifModified && (pe.lastModified[a] && T.setRequestHeader("If-Modified-Since", pe.lastModified[a]), pe.etag[a] && T.setRequestHeader("If-None-Match", pe.etag[a])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Kt + "; q=0.01" : "") : f.accepts["*"]);
    ...
    var tn = /%20/g, nn = /\[\]$/, rn = /\r?\n/g, on = /^(?:submit|button|image|reset|file)$/i,
    ...
    pe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && an.test(this.nodeName) && !on.test(e) && (this.checked || !$e.test(e))
            }).map(function (e, t) {
                var n = pe(this).val();
            ...
            return {
                send: function (r, i) {
                    ...
                    a.send(t.hasContent && t.data || null), n = function (e, r) {
                        var o, u, l;
                        if (n && (r || 4 === a.readyState)) if (delete un[s], n = void 0, a.onreadystatechange = pe.noop, r) 4 !== a.readyState && a.abort(); else {
    ...
    pe.ajaxSetup({
        jsonp: "callback", jsonpCallback: function () {
            var e = cn.pop() || pe.expando + "_" + Wt++;
            return this[e] = !0, e
        }
    }), pe.ajaxPrefilter("json jsonp", function (t, n, r) {
        var i, o, a,
            s = !1 !== t.jsonp && (dn.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && dn.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(dn, "$1" + i) : !1 !== t.jsonp && (t.url += (Bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    function n(e, n, r) {
        n = d[n] ? n : d[r] ? r : "en";
        var i = 0, o = e < 0 ? 1 : 0;
        for (e = Math.abs(e); e >= f[i] && i < p; i++) e /= f[i];
        return e = t(e), i *= 2, e > (0 === i ? 9 : 1) && (i += 1), d[n](e, i)[o].replace("%s", e)
    }
    ...
    function i(e) {
        for (var t = 1, n = 0, r = Math.abs(e); e >= f[n] && n < p; n++) e /= f[n], t *= f[n];
        return r %= t, r = r ? t - r : t, Math.ceil(r)
    }

    function o(e) {
        return e.dataset.timeago ? e.dataset.timeago : e.getAttribute ? e.getAttribute(h) : e.attr ? e.attr(h) : void 0
    }

    function a(e, t) {
        function a(o, u, l, c) {
            var d = r(u, e);
            o.innerHTML = n(d, l, t), s["k" + c] = setTimeout(function () {
                a(o, u, l, c)
            }, Math.min(1e3 * i(d), 2147483647))
        }

        var s = {};
        return t || (t = "en"), this.format = function (i, o) {
            return n(r(i, e), o, t)
        }, this.render = function (e, t) {
            void 0 === e.length && (e = [e]);
            for (var n = 0; n < e.length; n++) a(e[n], o(e[n]), t, ++u)
    ...
    var u = 0, l = "second_minute_hour_day_week_month_year".split("_"), c = "秒_分钟_小时_天_周_月_年".split("_"), d = {
        en: function (e, t) {
    ...
    }, f = [60, 60, 24, 7, 365 / 7 / 12, 12], p = 6, h = "datetime";
    ...
    e.fn.extend({
        scrollspy: function (n) {
            ...
            return this.each(function (t) {
                var r = this, i = n, o = e(i.container), a = i.mode, s = i.buffer, u = leaves = 0, l = !1;
                o.bind("scroll." + i.namespace, function (t) {
                    var n = {top: e(this).scrollTop(), left: e(this).scrollLeft()},
                        c = "vertical" == a ? n.top + s : n.left + s, d = i.max, f = i.min;
                    e.isFunction(i.max) && (d = i.max()), e.isFunction(i.min) && (f = i.min()), 0 == d && (d = "vertical" == a ? o.height() : o.outerWidth() + e(r).outerWidth()), c >= f && c <= d ? (l || (l = !0, u++, e(r).trigger("scrollEnter", {position: n}), e.isFunction(i.onEnter) && i.onEnter(r, n)), e(r).trigger("scrollTick", {
                        position: n,
                        inside: l,
                        enters: u,
                        leaves: leaves
    ...
    var e = $(".post-detail .description").find("h2"), t = document.createElement("ul");
    e.each(function (e) {
        var n = $(this), r = "sub-" + (e + 1), i = document.createElement("li"), o = document.createElement("a");
        o.setAttribute("href", "#" + r), o.innerHTML = n.text(), i.appendChild(o), t.appendChild(i), this.id = r, 0 === e && (o.className = "active");
        var a = $(this).position();
        n.scrollspy({
            min: a.top, max: a.top + n.height(), onEnter: function (e, n) {
                $(t).find("a").removeClass("active"), $(o).addClass("active")
            }, onLeave: function (e, t) {
            }
        })
    }), $("body").children(".affix").append(t), $(t).delegate("a", "click", function () {
        var e = $(this);
        $(t).find("a").removeClass("active"), e.addClass("active")
    }), function () {
        var e = $("#REWARD-MODAL img"), t = $("#REWARD-MODAL").children("p").children("span");
        $("#REWARD").on("click", function () {
            $("#REWARD-MODAL").show()
        }), $("#REWARD-MODAL").delegate(":radio", "change", function () {
            var n = this.value;
            e.attr("src", n), t.text(this.parentElement.textContent.trim())
        }), $("#REWARD-MODAL button.close").on("click", function () {
            $("#REWARD-MODAL").hide()
        })
    }(), function () {
        var e = !1, t = document.getElementById("mbMenu").firstElementChild, n = document.getElementById("mask-hide");
        document.getElementById("mbMenu").addEventListener("touchend", function (r) {
            e || (document.body.classList.add("show-side"), t.classList.remove("icon-menu"), t.classList.add("icon-close"), e = !0, n.classList.remove("d-none"))
        }), n.addEventListener("touchend", function (r) {
            e && (document.body.classList.remove("show-side"), t.classList.remove("icon-close"), t.classList.add("icon-menu"), e = !1, setTimeout(function () {
                n.classList.add("d-none")
            }, 300))
        })
    }(), function () {
        for (var e = document.getElementsByTagName("em"), t = 0, n = e.length; t < n; t++) if (null !== e[t].getAttribute("timeago")) {
            var r = e[t], i = r.textContent.trim();
            r.textContent = new timeago(null, "zh_CN").format(i)
        }
    }()
});