(function () {
    var h = {}, mt = {}, c = {
        id: "6d7c808dc688795e8cde39ccf5be1768",
        dm: ["xiaoboy.com"],
    ...
    (mt.h.Ea = function () {
        ...
        (function () {
            if (!d) if (d = r, "complete" === document.readyState) a.A = r; else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
    ...
    (function () {
        var a = mt.lang, b = h.D, d = h.load, f = {
            Ca: function (g) {
    ...
    (function () {
        ...
        var d = mt.lang, f = mt.l, g = mt.f, n = h.D, l = h.G, p = h.ha, e = {
            s: [], B: 0, Y: u, o: {T: "", page: ""}, init: function () {
                ...
                if (0 < e.s.length) for (var a = 0, d = e.s.length; a < d; a++) e.Q(e.s[a]);
                e.s = t
            }, Q: function (a) {
                var b = a[0];
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m) g.call(this, a); else for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.P).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
                }
    ...
    (function () {
        ...
        var b = mt.url, d = mt.aa, f = mt.S, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage,
        ...
        a.prototype = {
            N: function (a, b) {
                ...
                try {
                    n.set(a, b, {domain: this.I(), path: this.V(), H: d}), d ? p.set(a, b, d) : e.set(a, b)
                } catch (f) {
                }
            }, Fa: function (a) {
                try {
                    n.set(a, "", {domain: this.I(), path: this.V(), H: -1}), e.remove(a), p.remove(a)
                } catch (b) {
                }
            }, Ka: function () {
                var a, b, d, e, f;
